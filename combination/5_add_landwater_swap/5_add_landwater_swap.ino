/****************
   (Feb08) Add the 5th/final function: Land-water swap (combine "_land_water_swap")
  ...
  if (now.Minute() % 2 == 0) //"even" minute -> temperature, NO water changing
  {
    ...
    if (!temp_reset()) {
      ...
      { //board UP with NO pressure
        ...
        delay(3000); //(? needs physical test) time for pulley system works
