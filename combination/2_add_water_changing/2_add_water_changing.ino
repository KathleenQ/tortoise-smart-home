/****************
 * (Feb04 1) Add the 2nd function: Water Changing (combine "_water_changing" file)
 ...
 * Real-time clock: rtc(~CLK, I/O, RST) (e.g. rtc(6, 7, 8)).
 ****************/
//"WiFi Connection"
#include <SPI.h>
#include <WiFiNINA.h>
...
//for real-time clock module
//String weekDay(uint8_t dayofweek) //to show dayOfWeek in short-form string 
//{
//  if(dayofweek == 1){
//    return "Mon";
//  }
